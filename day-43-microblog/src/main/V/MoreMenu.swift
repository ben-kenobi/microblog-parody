...
//
    ...
    lazy var btns:[UIButton]={
        ...
        for var i in 0...5{
            ...
            btns.append(MenuBtn(frame: CGRectMake(col*btnw+pad,self.h+row*(btnh+20), btnw, btnh), img: iimg(self.btninfos[i]["icon"] as! String), title: self.btninfos[i]["title"] as? String, font: iFont(18), titleColor: UIColor.grayColor(),  tar: self, action: #selector(MoreMenu.btnClick(_:)), tag: 0))
