...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    if([self.sourceImagesContainerView isKindOfClass:[UICollectionView class] ]){
        sourceView=[((UICollectionView *)self.sourceImagesContainerView) cellForItemAtIndexPath:[NSIndexPath indexPathForItem:currentIndex inSection:0]];
    }else{
...
- (void)showFirstImage
{
    ...
    if([self.sourceImagesContainerView isKindOfClass: UICollectionView.class]){
        sourceView=[((UICollectionView *)self.sourceImagesContainerView) cellForItemAtIndexPath:[NSIndexPath indexPathForItem:self.currentImageIndex inSection:0]];
    }else {
